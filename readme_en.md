...
Utilizing the tools within `/tools/` enables efficient game data creation and conversion tasks. While the ÅgRecommended SoftwareÅh is not mandatory, installing it is recommended to utilize the full functionality.
...
* **`convgs`**: Scenario text Å® Script conversion
