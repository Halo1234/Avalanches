...
!macro MUIEX_FUNCTION_SHORTCUTLOCATION ENTER LEAVE
	...
	Function "${ENTER}"
		...
		!insertmacro MUI_HEADER_TEXT_PAGE "Create shortcut" "You can select the shortcut you need."
		...
		; ラベルテキスト
		${NSD_CreateLabel} 0 0 100% 45u "When you register the start menu, shortcuts to support tools will also be automatically registered. $\nUsually, we recommend registering this. $\nIf you do not create a shortcut to the uninstaller, you can uninstall it from the 'Add/Remove Programs' tool in the 'Control Panel'."
		Pop $muiex.sh.InfoText

		; スタートメニューの登録
		!ifdef MUIEX_SECID_CREATESTARTMENU

			${NSD_CreateCheckBox} 10u 65u 100% 12u "Register in the start menu. (Recommendation)"
			...
			!ifdef MUIEX_SECID_CREATEUNINSTALLSHORTCUTINSTARTMENU
				...
				${NSD_CreateCheckBox} 20u 80u 100% 12u "Create a shortcut to the uninstaller in the start menu."
		...
		!ifdef MUIEX_SECID_CREATEDESKTOPSHORTCUT
			...
			${NSD_CreateCheckBox} 10u 95u 100% 12u "Create a shortcut on your desktop."
		...
		Function MUIEX_SHORTCUTLOCATION_GetReport
			...
			!ifdef MUIEX_SECID_CREATESTARTMENU
				...
				!ifdef MUIEX_SECID_CREATEUNINSTALLSHORTCUTINSTARTMENU
					...
					uninstall_selected:
						StrCpy $0 "$0Shortcut to uninstaller:$\r$\n    create.$\r$\n$\r$\n"
						Goto uninstall_done
