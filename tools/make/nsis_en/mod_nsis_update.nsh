...
!define UNINSTALLER_ALIAS			"Uninstall"
...
!define MUI_ABORTWARNING_TEXT			"${SETUP_TITLE} setup is not complete. $\nDo you want to interrupt?"
!define MUI_UNABORTWARNING
!define MUI_UNABORTWARNING_TEXT			"${SETUP_TITLE} The uninstallation of has not been completed. $\nDo you want to interrupt?"
...
!define MUI_WELCOMEPAGE_TITLE 			"${SETUP_TITLE} setup program"
!define MUI_WELCOMEPAGE_TEXT 			"Start setup for ${SETUP_TITLE}. $\n$\nWe recommend closing all other applications before starting setup. $\n$\nClick Next to continue."
