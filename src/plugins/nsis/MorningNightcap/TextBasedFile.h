...
namespace impl {
	...
	public:
		static
		mbchar_type* ToSJIS(const buffer_type &wide, mbbuffer_type &mb);
		static
		mbchar_type* ToSJIS(const buffer_type::value_type *wide, buffer_type::size_type size, mbbuffer_type &mb);

		static
		char_type* JISTo(const mbbuffer_type &mb, buffer_type &wide);
		static
		char_type* JISTo(const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide);
		static
		char_type* EUCJPTo(const mbbuffer_type &mb, buffer_type &wide);
		static
		char_type* EUCJPTo(const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide);
		static
		char_type* SJISTo(const mbbuffer_type &mb, buffer_type &wide);
		static
		char_type* SJISTo(const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide);
		static
		char_type* UTF8To(const mbbuffer_type &mb, buffer_type &wide);
		static
		char_type* UTF8To(const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide);
		static
		char_type* UTF16To(const buffer_type &src, buffer_type &dest);
		static
		char_type* UTF16To(const buffer_type::value_type *mb, buffer_type::size_type size, buffer_type &wide);
		static
		char_type* UTF16BETo(const buffer_type &be, buffer_type &le);
		static
		char_type* UTF16BETo(const buffer_type::value_type *be, buffer_type::size_type size, buffer_type &le);
	};
