...
namespace impl {
	...
	/**/
	const CharacterConvertor::mbchar_type* CharacterConvertor::ToSJIS(const buffer_type &wide, mbbuffer_type &mb)
	{
		if(wide.empty())
			return KIM_AT("");
	...
	/**/
	const CharacterConvertor::mbchar_type* CharacterConvertor::ToSJIS(
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::JISTo(const mbbuffer_type &mb, buffer_type &wide)
	{
		if(mb.empty())
			return KIM_WT("");
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::JISTo(
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::EUCJPTo(const mbbuffer_type &mb, buffer_type &wide)
	{
		if(mb.empty())
			return KIM_WT("");
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::EUCJPTo(
		const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide)
	{
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::SJISTo(const mbbuffer_type &mb, buffer_type &wide)
	{
		if(mb.empty())
			return KIM_WT("");
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::SJISTo(
		const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide)
	{
		if(size == 0)
			return KIM_WT("");
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::UTF8To(const mbbuffer_type &mb, buffer_type &wide)
	{
		if(mb.empty())
			return KIM_WT("");
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::UTF8To(
		const mbbuffer_type::value_type *mb, mbbuffer_type::size_type size, buffer_type &wide)
	{
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::UTF16To(const buffer_type &src, buffer_type &dest)
	{
		if(src.empty())
			return KIM_WT("");
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::UTF16To(
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::UTF16BETo(const buffer_type &be, buffer_type &le)
	{
		if(be.empty())
	...
	/**/
	const CharacterConvertor::char_type* CharacterConvertor::UTF16BETo(
