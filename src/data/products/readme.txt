...
key フォルダには署名用のキーファイルを配置します。
 privには秘密鍵をコピペして保存してください。
 pubには公開鍵をコピペして保存してください。
 鍵は /tools/krkr/kirikiri2/tools/krkrsign.exe で生成したものをそのままコピペして保存してください。
...
override.ini は /tools/make/config.ini の各項目をオーバーライドします。
 詳しくは /tools/make/config.ini の各項目の説明を参照してください。
