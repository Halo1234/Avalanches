...
Place the key files for signing in the key folder.  
  Copy and paste the private key into the priv folder.  
  Copy and paste the public key into the pub folder.  
  Please copy and paste the keys generated by /tools/krkr/kirikiri2/tools/krkrsign.exe as they are and save them.
